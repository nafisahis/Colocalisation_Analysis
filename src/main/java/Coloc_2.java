...
public class Coloc_2<T extends RealType<T> & NativeType<T>> implements PlugIn {
	...
	/**
	 * Creates appropriate data structures from the ROI information passed. If an
	 * irregular ROI is found, it will be put into a frame of its bounding box
	 * size and put into an Image<T>. In the end the members ROIs, masks and
	 * maskBBs will be filled if ROIs or masks were found. They will be null
	 * otherwise.
	 */
